...
// SVG Icons
const MAGNIFY_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon">
  <g>
...
const SPEAKER_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon forreal-icon-speaker">
  <g>
...
const CHECK_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon forreal-icon-check">
  <g>
...
const WARNING_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon forreal-icon-warning">
  <g>
...
const QUESTION_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon forreal-icon-question">
  <g>
...
const X_ICON = `
<svg viewBox="0 0 24 24" aria-hidden="true" class="forreal-icon forreal-icon-false">
  <g>
